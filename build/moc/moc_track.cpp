...
Q_CONSTINIT static const qt_meta_stringdata_CLASSTrackENDCLASS_t qt_meta_stringdata_CLASSTrackENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(14, 0),  // ""
        QT_MOC_LITERAL(15, 9),  // "gotLyrics"
        QT_MOC_LITERAL(25, 6),  // "lyrics"
        QT_MOC_LITERAL(32, 7)   // "removed"
    },
    "Track",
    "gotInfo",
    "",
...
void Track::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->gotLyrics((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 2: _t->removed(); break;
        default: ;
        }
        ...
        {
            using _t = void (Track::*)();
            if (_t _q_method = &Track::gotInfo; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (Track::*)(QString );
            if (_t _q_method = &Track::gotLyrics; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (Track::*)();
            if (_t _q_method = &Track::removed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
...
// SIGNAL 1
void Track::gotLyrics(QString _t1)
{
